...
public interface SOAPification extends Service
{
     ...
     */
    void publish(Object obj, String publicationName, Class[] interfacesToExpose) throws SOAPificationException;
     ...
     */    
    void publish(Object obj, String publicationName, Class interfaceToExpose) throws SOAPificationException;
    /**
     ...
     * @param publicationName The name to publish it as.
     */    
    void publish(Object obj, String publicationName) throws SOAPificationException;
     ...
     */    
    void unpublish(String publicationName) throws SOAPificationException;
