 ...
 */
public class CacheRuntimeExceptionTestCase extends TestCase
{

    /**
     * Constructor for CacheRuntimeExceptionTestCase.
     * @param arg0
     */
    public CacheRuntimeExceptionTestCase( String arg )
    {
        super( arg );
    }
    ...
    final public void testMessageConstructor() throws Exception
    {
        try
        {
            CacheRuntimeException exception = new CacheRuntimeException( (String) null );
    ...
    final public void testThrowableConstructor() throws Exception
    {
        ...
        CacheRuntimeException exception = new CacheRuntimeException( message, cause );
