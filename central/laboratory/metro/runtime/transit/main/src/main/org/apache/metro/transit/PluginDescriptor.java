...
/**
 * A PluginDescriptor declares information about a plugin.
 * 
 * @author <a href="mailto:dev@avalon.apache.org">Avalon Development Team</a>
 * @version $Id: PluginDescriptor.java 30977 2004-07-30 08:57:54Z niclas $
 */
public class PluginDescriptor implements Serializable
{
     ...
     */
    public PluginDescriptor( final Attributes attributes ) 
    ...
    */
    ...
    {
        boolean isEqual = other instanceof PluginDescriptor;
        if ( isEqual )
        {
            PluginDescriptor meta = (PluginDescriptor) other;
