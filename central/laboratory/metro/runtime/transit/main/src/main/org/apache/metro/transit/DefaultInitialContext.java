 ...
 */
public class DefaultInitialContext implements InitialContext
{
    //------------------------------------------------------------------
    // immutable state 
    //------------------------------------------------------------------
    ...
    */
      ...
      throws RepositoryException
    {
        ...
        m_cache = cache;
        m_hosts = new String[0];
        m_online = false;
        m_timestamp = Policy.FAST;
        m_debug = false;
        m_monitor = new ConsoleMonitor( m_debug );
    }
     ...
     * @throws RepositoryException if an error occurs during establishment
     */
    public DefaultInitialContext( File home, Properties properties ) 
      throws RepositoryException
    {
        if( null == home ) throw new NullPointerException( "home" ); 
    ...
    */
    ...
    private Policy getTimestampPolicy( Properties properties ) throws RepositoryException
    {
        try
        {
        ...
        {
            throw new RepositoryException( "Illigal policy.", pe );
        }
    }
