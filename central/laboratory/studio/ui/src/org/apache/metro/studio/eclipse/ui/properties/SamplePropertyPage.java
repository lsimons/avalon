 ...
 *  
 */
package org.apache.metro.studio.eclipse.ui.properties;
...
public class SamplePropertyPage extends PropertyPage 
{
    ...
    private void addSecondSection( Composite parent ) 
    {
        ...
        try 
        {
            QualifiedName qname = new QualifiedName("", OWNER_PROPERTY);
            IResource resource = (IResource) getElement();
            String owner = resource.getPersistentProperty( qname );
    ...
    public boolean performOk() 
    {
        ...
        try 
        {
            QualifiedName qname = new QualifiedName("", OWNER_PROPERTY);
            IResource resource = (IResource) getElement();
            resource.setPersistentProperty( qname, ownerText.getText());
        } catch( CoreException e ) 
        {
            return false;
        }
