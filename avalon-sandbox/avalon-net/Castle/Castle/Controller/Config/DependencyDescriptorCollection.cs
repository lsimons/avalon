...
namespace Apache.Avalon.Castle.Controller.Config
{
	...
	/// <summary>
	/// Summary description for DependencyDescriptorCollection.
	/// </summary>
	public class DependencyDescriptorCollection : CollectionBase
	{
		...
		public void Add(DependencyDescriptor desc)
		{
			InnerList.Add(desc);
		}
