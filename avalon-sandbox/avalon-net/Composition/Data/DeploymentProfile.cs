...
namespace Apache.Avalon.Composition.Data
{
	...
	/// <summary> Abstract base class for ComponentProfile and ContainmentProfile.
	/// 
	/// </summary>
	...
	public abstract class DeploymentProfile
	{
		...
		public DeploymentProfile(System.String name, ActivationPolicy activation, Mode mode)
		{
