 ...
 * @version $Id: EnvironmentException.java 30977 2004-07-30 08:57:54Z niclas $
 */
public class EnvironmentException extends RuntimeException
{
    ...
    */
     ...
     */
    EnvironmentException( final Throwable a_cause )
    {
        super() ;
     ...
     */
    EnvironmentException( final String a_message )
    {
        super( a_message ) ;
     ...
     * @param a_cause the underlying exception that caused the failure
     */
    EnvironmentException( final String a_variable, final Throwable a_cause )
    {
        super() ;
     ...
     * @param a_message the reason for the access failure 
     */
    EnvironmentException( final String a_variable, final String a_message )
    {
        super( a_message ) ;
