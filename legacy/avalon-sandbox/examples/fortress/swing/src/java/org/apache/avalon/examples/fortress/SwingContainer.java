...
import org.apache.avalon.examples.translator.Translator;
 ...
 * @version CVS $Revision: 1.1 $ $Date: 2004/02/29 08:41:41 $
 */
    ...
    implements org.apache.avalon.framework.activity.Startable, java.awt.event.ActionListener, Runnable
{
        ...
        throws Exception
    {
        ...
        m_translator = (Translator) m_serviceManager.lookup(Translator.class.getName());
