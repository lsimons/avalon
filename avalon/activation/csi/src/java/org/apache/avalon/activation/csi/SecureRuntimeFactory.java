 ...
 */
public class SecureRuntimeFactory implements RuntimeFactory
{
    //-------------------------------------------------------------------
    // static
    //-------------------------------------------------------------------
    ...
    public SecureRuntimeFactory( SystemContext system )
    {
        m_system = system;
        m_factory = new SecureLifestyleFactory( m_system );
    }
    ...
    */
    ...
    {
        return new SecureAppliance( model, manager );
    }
    ...
    */
    ...
    {
        return new SecureBlock( m_system, model );
    }
