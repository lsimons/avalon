 ...
 */
public class SecureBlock extends SecureAbstractAppliance
{
    //-------------------------------------------------------------------
    // static
    //-------------------------------------------------------------------
    ...
    public SecureBlock( SystemContext system, ContainmentModel model )
    ...
    */
    ...
    {
        private final SecureBlock m_block;
