 ...
 * @version $Revision: 1.1 $ $Date: 2004/02/10 16:14:11 $
 */
public abstract class SecureAbstractAppliance implements Appliance
{
    //-------------------------------------------------------------------
    // immutable state
    //-------------------------------------------------------------------
    ...
    public SecureAbstractAppliance( DeploymentModel model )
    {
        if( null == model ) 
        {
