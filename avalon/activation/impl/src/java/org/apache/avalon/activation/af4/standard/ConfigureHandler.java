...
public class ConfigureHandler extends AbstractLogEnabled
    implements LifecycleCreateExtension
{
    private static final Resources REZ =
      ResourceManager.getPackageResources( ConfigureHandler.class );
      ...
      throws CreationException
    {
        if( instance instanceof Configurable )
        {
            ...
            {
                String errorMessage = "Unable to configure component.";
