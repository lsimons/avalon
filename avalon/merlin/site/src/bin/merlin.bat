...
java -Djava.security.policy=%MERLIN_HOME%\bin\security.policy -Dmerlin.dir=%MERLIN_HOME% -Djava.ext.dirs=%MERLIN_EXT_DIR% -jar %MERLIN_BOOTSTRAP_JAR% %MERLIN_CMD_LINE_ARGS%
goto EndOfScript
